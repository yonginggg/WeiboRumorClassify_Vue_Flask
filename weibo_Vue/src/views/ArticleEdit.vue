  ...
  <div class="container">
    <div class="header">
      <div class="title-input">
        <blog-input placeholder="请输入动态标题" v-model="title"></blog-input>
      </div>
      <div class="push-article">
        <blog-button @click="saveArticle" type="primary">发布动态</blog-button>
      </div>
    </div>
    <div class="body">
    ...
    >
      <form-item label="内容">
        <blog-input  v-model="hostKey"></blog-input>
      </form-item>
