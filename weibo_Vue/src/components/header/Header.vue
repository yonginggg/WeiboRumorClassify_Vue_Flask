...
<!--        <menu-item class="menu-item" title="空间" :to="welcome"></menu-item>-->
<!--&lt;!&ndash;        <menu-item class="menu-item" title="关于我" to="/about"></menu-item>&ndash;&gt;-->
...
export default {
  data() {
    return {
      ...
      // loginAreaShow: true,
      username: "",
      welcome:"/welcome/"+localStorage.getItem("userId")
    };
  },
  components: {
    MenuItem,
  ...
  methods: {
    backhome(){
      window.location.href = "http://localhost:12322/#/welcome/"+localStorage.getItem("userId");
